...
class Sonoff:
    def __init__(self, username:str, password:str, timezone:str='US/Pacific' , region:str='us'):
        ...
        self.appid = 'YzfeftUVcZ6twZw1OoVKPRFYTrGEg01Q' #'oeVkj2lYFGnJu5XUtWisfW4utiN4u9Mq'
        self.appsecret = '4G91qSoboqYO4Y0XJ0LPPKIsq8reHdfa' #'6Nz4n0xA8s8qdxQf2GqurZj2Fs55FUvM'
    ...
    def change_device_status(self, deviceid:str, new_status:str):
        ...
        if new_status == self.status:
            ...
            return f'device is already {new_status}'
        payload = {
            'deviceid': deviceid,
        ...
        if r.json()['error'] == 0:
            ...
            return f"status successfully changed to {new_status}"
